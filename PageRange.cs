...
namespace UIXDialogBuilder//TODO: create custom editor
{
    /// <summary>
    ...
    public class PageRange : IEnumerable<int>
    {
        ...
        public static IList<PageRange> FromString(string pageString)
        {
                ...
                switch (numbers.Length)
                {
                    ...
                    case 2:
                            ...
                            && int.TryParse(numbers[1], out int b))
                        {
                            ...
                            if (range.Count > 9999)
                            {
                                //hard limit # of generated files to prevent endless lockup of Resonite, TODO: remove hardcoded limit in favor of TotalCount property or something similar
                                return null;
                            }
